...
# 载入已经训练好的分类器
clf = joblib.load("..\\models-machine-learning\\rbf_support_vector_classification_total-revenue_lines.pkl")

# 读入需要分析预测的文件
folder_path_lines = path.dirname(path.dirname(path.abspath(__file__))) + "\\documents-convert\\lines-income-statements"
