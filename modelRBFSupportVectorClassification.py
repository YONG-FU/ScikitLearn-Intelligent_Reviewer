...
class TrainingModel:
    ...
    def __generate_train_model_common(self, datasets_categories, dumpFile):
        ...
        # 使用支持向量机方法训练分类器
        clf = NuSVC().fit(X_train_tfidf, datasets_train.target)
    ...
    def __generate_page_train_model(self):
        ...
        path = 'models-machine-learning\\rbf_support_vector_classification_' + self.__page_keyword + '_pages.pkl'
    ...
    def __generate_line_train_model(self):
        ...
        path = 'models-machine-learning\\rbf_support_vector_classification_' + self.__line_keyword + '_lines.pkl'
